// Original work copyright (c) .NET Foundation and Contributors, MIT License (https://github.com/dotnet/corefx/blob/v2.0.7/LICENSE.TXT)
// Modifications copyright (c) 2018 Charlie Poole, Rob Prouse, MIL License (see LICENSE.txt in the root of this repo)
// Polyfill from https://raw.githubusercontent.com/dotnet/corefx/v2.0.7/src/System.Threading/src/System/Threading/CountdownEvent.cs
...
#pragma warning restore 0420
        ...
        public bool Wait(int millisecondsTimeout)
        {
            ...
            {
                // ** the actual wait
                returnValue = _event.Wait(millisecondsTimeout);
            }
