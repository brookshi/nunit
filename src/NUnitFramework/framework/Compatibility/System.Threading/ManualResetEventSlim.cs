// Original work copyright (c) .NET Foundation and Contributors, MIT License (https://github.com/dotnet/coreclr/blob/v2.0.7/LICENSE.TXT)
// Modifications copyright (c) 2018 Charlie Poole, Rob Prouse, MIL License (see LICENSE.txt in the root of this repo)
// Polyfill from https://raw.githubusercontent.com/dotnet/coreclr/v2.0.7/src/mscorlib/src/System/Threading/ManualResetEventSlim.cs
        ...
        private int Waiters
        {
            ...
            set
            {
                ...
                if (value >= NumWaitersState_MaxValue)
                    throw new InvalidOperationException(String.Format("There are too many threads currently waiting on the event. A maximum of 524287 waiting threads are supported.", NumWaitersState_MaxValue));
        ...
        public ManualResetEventSlim(bool initialState, int spinCount)
        {
            ...
            if (spinCount > SpinCountState_MaxValue)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(spinCount),
                    String.Format("The spinCount argument must be in the range 0 to {0}, inclusive.", SpinCountState_MaxValue));
            }
